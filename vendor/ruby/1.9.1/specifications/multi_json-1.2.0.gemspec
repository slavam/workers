...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md", "README.md", "Rakefile", "multi_json.gemspec", "Gemfile", ".document", ".rspec", ".travis.yml", "spec/engine_shared_example.rb", "spec/helper.rb", "spec/multi_json_spec.rb", "lib/multi_json/engines/json_common.rb", "lib/multi_json/engines/json_gem.rb", "lib/multi_json/engines/json_pure.rb", "lib/multi_json/engines/nsjsonserialization.rb", "lib/multi_json/engines/oj.rb", "lib/multi_json/engines/ok_json.rb", "lib/multi_json/engines/yajl.rb", "lib/multi_json/vendor/ok_json.rb", "lib/multi_json/version.rb", "lib/multi_json.rb"]
  s.homepage = %q{http://github.com/intridea/multi_json}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.5.2}
  s.summary = %q{A gem to provide swappable JSON backends.}
  s.test_files = ["spec/engine_shared_example.rb", "spec/helper.rb", "spec/multi_json_spec.rb"]
